#!/usr/bin/env python3
"""Build the 'acc-fix' variant (RES+ context-gated + LIM) for the BCM app VBF.
  RES+ : if 0x0C0 d0 bit6 (cancelled/really-paused) @0x40000707 -> CC_Res (d5.5)
         else CC_Set_Plus (d5.7); clear d1.6
  LIM  : d1.5 -> d6[5:6]=0b10 pressed; clear d1.5
APP/EXE only. Hooks FUN_000fc218@0xFC2C2 + FUN_000fc2f6@0xFC440. Caves 0x117100/0x117300.
Repairs internal sum8@0x13FFFE + block CRC16 + file CRC32.
...
outp=os.path.join(OUT,"JV6T-14C094-AD_acc-fix.VBF"); open(outp,'wb').write(d)
